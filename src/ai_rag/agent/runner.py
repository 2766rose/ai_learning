...
1. 实时信息（时间/日期/天气等） → get_current_time
2. 企业内部知识/文档/业务规范/产品手册 → knowledge_search
3. 文件上传/文档管理操作 → doc_upload
4. 用户主动告知个人偏好、事实、身份等信息 → save_user_memory
