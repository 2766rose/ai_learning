...
from src.ai_rag.core.text_splitter import text_splitter
...
def ingest_texts(
    ...
    """
    if not texts:
        return {"chunks_created": 0, "docs_stored": 0, "total_in_collection": vector_store.count}
    ...
    for i in range(0, len(chunks), batch_size):
        ...
        stored += vector_store.add_documents(batch_texts, batch_metas)
